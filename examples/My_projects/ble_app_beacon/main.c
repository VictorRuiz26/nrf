...
static void app_timer_ble_interval_handler (void *p_context)
{
...
static void timers_init(void)
{
    ...
    err_code = app_timer_create(&m_timer_ble, APP_TIMER_MODE_REPEATED, app_timer_ble_interval_handler);
    APP_ERROR_CHECK(err_code);
...
int main(void)
{
    ...
    uint32_t err_code = app_timer_start(m_timer_ble, ADV_INTERVAL, NULL);
